...
namespace GameAssets.General
{
    public static class SaveSystem
    {
        ...
        private static readonly WaitForSeconds SaveDelay = new WaitForSeconds(SAVE_DELAY);
...
#elif PLAYFAB
            SavePlayFab(gameDataSaves, otherDataSaves);
#else
#endif
        }

        public static void SaveAllData() => PerformSave();
    }
}