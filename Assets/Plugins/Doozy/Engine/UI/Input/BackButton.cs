    ...
    public class BackButton : MonoBehaviour
    {
        ...
        public static BackButton Instance
        {
            get
            {
                ...
                s_instance = FindFirstObjectByType<BackButton>();
        ...
        private void Update()
        {
            ...
            switch (BackButtonInputData.InputMode)
            {
                case InputMode.KeyCode:
                        ...
                        BackButtonInputData.EnableAlternateInputs && UnityEngine.Input.GetKeyDown(BackButtonInputData.KeyCodeAlt))
                    {
                        if (DebugComponent) DDebug.Log(
                            $"Back button detected via KeyCode: {BackButtonInputData.KeyCode}", Instance);
                ...
                case InputMode.VirtualButton:
                    ...
                    {
                        if (DebugComponent) DDebug.Log(
                            $"Back button detected via Virtual Button: {BackButtonInputData.VirtualButtonName}", Instance);
                        triggerBackButton = true;
                    }
