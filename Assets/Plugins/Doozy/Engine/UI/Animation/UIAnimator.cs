...
//            Vector3 rotationB = RotateLoopRotationB(animation, startValue);
        ...
        public static Vector3 GetToPositionByDirection(RectTransform target, UIAnimation animation, Vector3 startValue)
        {
            ...
            if (canvas)
            {
                ...
                rootCanvasRect = rootCanvas.GetComponent<RectTransform>().rect;
            }
            else
            {
                rootCanvasRect = target.rect;
            }
        ...
        public static string GetTweenId(RectTransform target, AnimationType animationType, AnimationAction animationAction) { return
            $"{target.GetInstanceID()}-{animationType}-{animationAction}"; }
