...
namespace Doozy.Engine.UI
{
    ...
    public class UIButton : UIComponentBase<UIButton>, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler, IPointerClickHandler, ISelectHandler, IDeselectHandler
    {
        ...
        public override void OnDisable()
        {
            ...
            Coroutiner.Stop(m_disableButtonCoroutine);
            m_disableButtonCoroutine = null;
            EnableButton();
        }
        ...
        public void DisableButton(float duration)
        {
            ...
            DisableButton();
            m_disableButtonCoroutine = Coroutiner.Start(DisableButtonEnumerator(duration));
        }
        ...
        public void ExecutePointerEnter(bool debug = false)
        {
            ...
            Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnPointerEnter));
            if (OnPointerEnter.DisableInterval > 0) Coroutiner.Start(DisableButtonBehaviorEnumerator(OnPointerEnter));
        ...
        public void ExecutePointerExit(bool debug = false)
        {
            ...
            Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnPointerExit));
            if (OnPointerExit.DisableInterval > 0) Coroutiner.Start(DisableButtonBehaviorEnumerator(OnPointerExit));
        ...
        public void ExecutePointerDown(bool debug = false)
        {
            ...
            Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnPointerDown));
        ...
        public void ExecutePointerUp(bool debug = false)
        {
            ...
            Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnPointerUp));
        ...
        public void ExecuteClick(bool debug = false)
        {
            if (OnClick.Enabled)
            {
                ...
                if (Interactable)
                {
                    Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnClick));
        ...
        public void ExecuteDoubleClick(bool debug = false)
        {
            if (OnDoubleClick.Enabled)
            {
                ...
                if (Interactable)
                {
                    Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnDoubleClick));
        ...
        public void ExecuteLongClick(bool debug = false)
        {
            if (OnLongClick.Enabled)
            {
                ...
                if (Interactable)
                {
                    Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnLongClick));
        ...
        public void ExecuteRightClick(bool debug = false)
        {
            if (OnRightClick.Enabled)
            {
                ...
                if (Interactable)
                {
                    Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnRightClick));
        ...
        public void ExecuteOnButtonDeselected(bool debug = false)
        {
            ...
            Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnDeselected));
            if (OnDeselected.DisableInterval > 0) Coroutiner.Start(DisableButtonBehaviorEnumerator(OnDeselected));
        ...
        public void ExecuteOnButtonSelected(bool debug = false)
        {
            ...
            Coroutiner.Start(ExecuteButtonBehaviorEnumerator(OnSelected));
            if (OnSelected.DisableInterval > 0) Coroutiner.Start(DisableButtonBehaviorEnumerator(OnSelected));
        ...
        private void InitiateClick(bool debug = false)
        {
            ...
            Coroutiner.Start(RunOnClickEnumerator(debug));
        }
        ...
        private void RegisterLongClick(bool debug = false)
        {
            ...
            ResetLongClick(debug);
            m_longClickRegisterCoroutine = Coroutiner.Start(RunOnLongClickEnumerator(debug));
        }
        ...
        private void ResetLongClick(bool debug = false)
        {
            ...
            Coroutiner.Stop(m_longClickRegisterCoroutine);
            m_longClickRegisterCoroutine = null;
        }
        ...
        private IEnumerator ExecuteButtonBehaviorEnumerator(UIButtonBehavior behavior)
        {
            ...
            switch (behavior.BehaviorType)
            {
                ...
                case UIButtonBehaviorType.OnRightClick:
                    ...
                    {
                        if (DebugComponent) DDebug.Log(
                            $"({ButtonName}) UIButton - {behavior.BehaviorType} - Deselect Button.", this);
                        DeselectButton();
                    }
                ...
                case UIButtonBehaviorType.OnPointerEnter:
                    ...
                    {
                        if (DebugComponent) DDebug.Log(
                            $"({ButtonName}) UIButton - {behavior.BehaviorType} - Select Button.", this);
                        SelectButton();
                    }
