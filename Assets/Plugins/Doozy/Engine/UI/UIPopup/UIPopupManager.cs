    ...
    public class UIPopupManager : MonoBehaviour
    {
        ...
        public static UIPopupManager Instance
        {
            get
            {
                ...
                s_instance = FindFirstObjectByType<UIPopupManager>();
        ...
        private void Awake()
        {
            ...
            {
                DDebug.Log(
                    $"There cannot be two {typeof(UIPopupManager)}' active at the same time. Destroying this one!");
                Destroy(gameObject);
                return;
            }
        ...
        public static UIPopup GetPopup(string popupName)
        {
            ...
            {
                DDebug.Log(
                    $"No Popup with the name '{popupName}' has been defined in the Popups Database. Open the Control Panel at the Popups section and add it there.");
                return null;
            }
            ...
            {
                DDebug.Log(
                    $"No Popup prefab with the '{popupName}' PopupName has been defined in the Popups Database. Open the Control Panel at the Popups section and add it there.");
                return null;
            }
