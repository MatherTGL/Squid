...
namespace Doozy.Engine.UI
{
    ...
    public class UIPopup : UIComponentBase<UIPopup>
    {
        ...
        public void Hide(bool instantAction = false)
        {
            ...
            {
                DDebug.Log(
                    $"You are trying to HIDE the ({name}) UIPopup, but you did not enable any HIDE animations. Enable at least one HIDE animation in order to fix this issue.", this);
        ...
        public void Show(bool instantAction = false)
        {
            ...
            {
                DDebug.Log(
                    $"You are trying to SHOW the ({name}) UIPopup, but you did not enable any SHOW animations. Enable at least one SHOW animation in order to fix this issue.", this);
