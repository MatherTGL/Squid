...
namespace Doozy.Engine.UI
{
    ...
    public class UICanvas : UIComponentBase<UICanvas>
    {
        ...
        private static void CreateComponent(MenuCommand menuCommand)
        {
            ...
            UICanvas[] searchResults = FindObjectsByType<UICanvas>(FindObjectsSortMode.None); //search the entire scene for any Source that may have an UICanvas component attached
        ...
        public override void Awake()
        {
            ...
            {
                DDebug.LogError(
                    $"Error duplicate UICanvas found. You cannot have multiple UICanvases with the same canvas name. This error originated from the UICanvas component attached to the {name} gameObject. The duplicate canvas name is '{CanvasName}'.",
                               this);
        ...
        public static UICanvas CreateUICanvas(string canvasName)
        {
            ...
            {
                DDebug.Log(
                    $"Cannot create a new UICanvas with the '{canvasName}' canvasName because another UICanvas with the same name already exists in the UICanvas.Database. Returned the existing UICanvas instead.");
...
#if UNITY_EDITOR
            UICanvas[] searchResults = FindObjectsByType<UICanvas>(FindObjectsSortMode.None);
