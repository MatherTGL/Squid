    ...
    public class SoundyManager : MonoBehaviour
    {
        ...
        public static SoundyManager Instance
        {
            get
            {
                ...
                s_instance = FindFirstObjectByType<SoundyManager>();
        ...
        public static string GetSoundDatabaseFilename(string databaseName) { return
        ...
        public static SoundyController Play(string databaseName, string soundName, Vector3 position)
        {
            ...
            if (Instance.DebugComponent) DDebug.Log(
                $"Play '{databaseName}' / '{soundName}' SoundGroupData at {position} position", Instance);
        ...
        public static SoundyController Play(string databaseName, string soundName, Transform followTarget)
        {
            ...
            if (soundGroupData == null) return null;
            if (Instance.DebugComponent) DDebug.Log(
                $"Play '{databaseName}' / '{soundName}' SoundGroupData and follow the '{followTarget.name}' GameObject", Instance);
